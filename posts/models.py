...
class AuthorProfile(BaseModel):
    ...
    avatar = models.ForeignKey('medias.Media', on_delete=models.SET_NULL, null=True, blank=True)
...
class Post(BaseModel):
    ...
    cover_media = models.ForeignKey('medias.Media', on_delete=models.SET_NULL, null=True, blank=True, related_name='post_covers')
    seo_title = models.CharField(max_length=255, blank=True)
    seo_description = models.TextField(blank=True)
    og_image = models.ForeignKey('medias.Media', on_delete=models.SET_NULL, null=True, blank=True, related_name='post_og_images')
    views_count = models.PositiveIntegerField(default=0)
    tags = models.ManyToManyField(Tag, through='PostTag')
    reactions = GenericRelation('interactions.Reaction', object_id_field='object_id', content_type_field='content_type')

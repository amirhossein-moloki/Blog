...
├── articles/                  # Content Management (The Core)
...
| **medias** | Asset Library | `Media`, `Media` | Upload, Download | `users`, `common` |
...
2. **Engagement → Content:** `interactions.Comment` relates directly to `articles.Article`.

...
### 1. `posts.tasks.publish_scheduled_articles_task`
...
- **Service Called:** `posts.services.publish_scheduled_articles()`.
...
| :--- | :--- | :--- |
| `publish-scheduled-articles` | `posts.tasks.publish_scheduled_articles_task` | Every 1 Minute |
